...
@section ('title', 'Event Management' . ' | ' . 'Edit Event')
...
@section('content')
    {{ Form::model($event, ['route' => ['admin.events.update', $event], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-role']) }}
        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {{ Form::text('event_start_datetime', date('m/d/Y h:i A', strtotime($event->event_start_datetime)), ['class' => 'form-control', 'placeholder' => 'Start Time', 'required' => 'required', 'id' => 'startTime']) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {{ Form::text('event_end_datetime', date('m/d/Y h:i A', strtotime($event->event_end_datetime)), ['class' => 'form-control', 'placeholder' => 'End Time', 'required' => 'required', 'id' => 'endTime']) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-1">
                        {{ Form::checkbox('event_status', '1', $event) }}
                    </div><!--col-lg-1-->
                </div><!--form control-->
